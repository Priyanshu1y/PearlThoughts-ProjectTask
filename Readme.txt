...
1. pull the repository into your computer using repositories https link.
2. install the Node package in your computer.
3. run the command : node project_test_script.js
